...
def evaluate_two_class_unambiguous_model_add_blur_after_attack(
...
def evaluate_two_class_mnist_model_blur(model_fn, dataset_iter=None, model_name=None):
  """
  ...
  return evaluate_two_class_unambiguous_model_add_blur_after_attack(
    model_fn, dataset_iter,
    model_name=model_name,
    attack_list=attack_list[:2])
